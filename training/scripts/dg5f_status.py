...
DISPLAY_TAGS = (
    ...
    "Grasp/MaxContactFingerCount",
    "Grasp/MaxNonThumbContactCount",
    "Grasp/ThumbContactReached",
    "Grasp/StableContactReached",
    "Grasp/StableGraspAcquired",
    "Lift/MaxHeightMeters",
    "Hold/MaxValidSeconds",
    "Reach/Success",
