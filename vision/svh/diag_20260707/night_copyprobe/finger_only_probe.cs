...
string csvPath = Path.Combine(outDir, "finger_only_log.csv");
string sumPath = Path.Combine(outDir, "finger_only_summary.txt");
...
return "SETUP OK (finger-only). bodies=" + hand.GetComponentsInChildren<ArticulationBody>().Length +
