...
{
    /// <summary>Reports contact between one moving robot collider and the support panel.</summary>
    public sealed class ReachSurfaceContactSensor : MonoBehaviour
    {
        public Dg5fGraspPointReachAgent agent;
